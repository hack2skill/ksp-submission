...
def getDetailsFromTwitterHandle(username: str) -> dict:
    twitter_info = get_user_information(username)

    google_ts_res_plain = search_text(twitter_info['user_name'], no_of_results=10)
    google_ts_res_facebook = search_text("site:facebook.com " + twitter_info['user_name'], no_of_results=5)
    google_ts_res_twitter = search_text("site:twitter.com " + twitter_info['user_name'], no_of_results=5)
    google_ts_res_instagram = search_text("site:instagram.com " + twitter_info['user_name'], no_of_results=5)
    google_ts_res_linkedin = search_text("site:linkedin.com " + twitter_info['user_name'], no_of_results=5)
   
    google_ts_res_zabuacorp = search_text(twitter_info['user_name'] + " Zaubacorp", no_of_results=5)
    google_ts_res_indiakanoon = search_text(twitter_info['user_name'] + " IndiaKanoon", no_of_results=5)

    top_tweet_desc = twitter_info['user_description']
    entity_context = extract_entity_string(top_tweet_desc)
    google_ts_entity_res_facebook = search_text("site:facebook.com " + twitter_info['user_name'] + " " + entity_context, no_of_results=5)
    google_ts_entity_res_twitter = search_text("site:twitter.com " + twitter_info['user_name'] + " " + entity_context, no_of_results=5)
    google_ts_entity_res_instagram = search_text("site:instagram.com " + twitter_info['user_name'] + " " +entity_context, no_of_results=5)
    google_ts_entity_res_linkedin = search_text("site:linkedin.com " + twitter_info['user_name'] + " " + entity_context, no_of_results=5)
    google_is_entity_res_facebook = search_image("site:facebook.com " + twitter_info['user_name'] + " " + entity_context, no_of_results=5)
    google_is_entity_res_twitter = search_image("site:twitter.com " + twitter_info['user_name'] + " " + entity_context, no_of_results=5)
    google_is_entity_res_instagram = search_image("site:instagram.com " + twitter_info['user_name'] + " " +entity_context, no_of_results=5)
    google_is_entity_res_linkedin = search_image("site:linkedin.com " + twitter_info['user_name'] + " " + entity_context, no_of_results=5)
    google_is_res_entity = search_image(twitter_info['user_name'] + " " + entity_context, no_of_results=5)
    google_is_res_name = search_image(twitter_info['user_name'], no_of_results=5)
...
def generate_response(data):
    ...
    result = {}
    result['name'] = data['twitter'][0]['user_name']
