...
//
//   const URL = "https://teachablemachine.withgoogle.com/models/IIWwvGcY8/";
//
//   const configt ={
//     classes: ["Bhuvanesh", "Ashwathy"],
//     modelJson: URL + "model.json",
//     metadataJson: URL + "metadata.json",
//   }
//
...
//     const classifier = ml5.imageClassifier(URL + "model.json", () => {
...
//
//     axios.post('https://ashwinbiju09.pythonanywhere.com/', form_data).then((res) => console.log(res))
//   };
//
//   return (
...
//               <h1 className="title text-3xl">Face verification Lookup</h1>
...
//                   {/*  </svg>*/}
//                   {/*</button>*/}
//                   <input type={"file"} className="rounded-xl flex space-x-2 bg-[#BDFF00] p-3 text-black title">
//                     {/*Import from file*/}
//                     {/*<svg*/}
//                     {/*  xmlns="http://www.w3.org/2000/svg"*/}
//                     {/*  fill="none"*/}
  ...
  return (
      <div className="w-full">
        <div className="flex justify-between w-full">
          <div className="w-3/4  h-screen ml-20">
            <div className="flex justify-between mt-4 mx-10 items-center">
              <h1 className="title text-3xl">Face Lookup</h1>
              <h1 className="desc text-lg">Hello, admin!</h1>
            </div>
            <div className="flex">
              <div className="w-1/2">
