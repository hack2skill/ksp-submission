...
urlpatterns = [
    ...
    path('instagramscrap', views.instagramscrap, name='instagramscrap'),
    path('twitterscrap', views.twitterscrap, name='twitterscrap'),
    path('linkedinscrap', views.linkedinscrap, name='linkedinscrap'),
    path('githubscrap', views.githubscrap, name='linkedinscrap'),
    path('quorascrap', views.quorascrap, name='quorascrap'),
    path('mediumscrap', views.mediumscrap, name='mediumscrap'),
    path('facebookscrap', views.facebookscrap, name='facebookscrap'),
    path('pinterestscrap', views.pinterestscrap, name='pinterestscrap'),
    path('combinedscrap', views.combinedscrap, name='combinedscrap'),
    path('emaildata', views.emaildata, name='emaildata'),
    path('phonedata', views.phonedata, name='phonedata'),
    path('bindata', views.bindata, name='bindata'),
